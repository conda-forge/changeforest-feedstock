...
Once the `conda-forge` channel has been enabled, `changeforest` can be installed with:

```
conda install changeforest
```

It is possible to list all of the versions of `changeforest` available on your platform with:
